...
---
# SEÇÕES ESPECÍFICAS — LIQUIDITY ENGINE V3

## Ownership do Domínio (Confirmado)

Liquidity é dona exclusiva de:
- `LiquidityPoolV3`
- `LiquidityPoolMemberV3`
- `LiquidityEventV3`
- `LiquidityEngineStateV3`

**Regra:** Liquidity não re-detecta EQH/EQL. Usa `EqualLevelLiquidityPromoter` para promover clusters do Swing. Consome DealingRangeV3 de Retracement.

## Contratos Produzidos

| Contrato | Consumidor | Gate |
|---|---|---|
| `LiquidityEventV3` | FVG, OB | G6 |

## Contratos Consumidos

| Contrato | Produtor | Gate |
|---|---|---|
| `EqualLevelClusterV3` | Swing | G2 |
| `SwingSmcRoleProjectionV3` | Structure | G3 |
| `PreviousPeriodLevelV3` | Previous Period | G4 |
| `DealingRangeV3` | Retracement | G5 |

## Gate de Entrada

G5 (Dealing Range Ready)

## Gate de Saída

**G6 — Liquidity Ready:** EQH/EQL promoter, structure/previous-period pools, ERL/IRL, lifecycle, deduplicação.

## Regra Crítica

- `EqualLevelLiquidityDetector` → renomeado para `EqualLevelLiquidityPromoter`
- Liquidity promove o cluster, atribui BSL/SSL, role, range type e lifecycle
- Parâmetros geométricos de igualdade pertencem ao Swing
- Buffers de sweep e lifecycle pertencem à Liquidity

## Caminhos Batch

- `smc_engine_v3/liquidity.py`

## Caminhos Incrementais

- `incremental/components/liquidity.py`
