...
---
# SEÇÕES ESPECÍFicas — RETRACEMENT & PRICING ENGINE V3

## Ownership do Domínio (Confirmado)

Retracement é dono exclusivo de:
- `DealingRangeV3`
- `RetracementSampleV3`
- `RetracementEventV3`
- `RangeRevisionV3`
- `RetracementEngineStateV3`

**Regra:** Retracement é o único produtor de `DealingRangeV3`. Liquidity não pode recriar o dealing range.

## Contratos Produzidos

| Contrato | Consumidor | Gate |
|---|---|---|
| `DealingRangeV3` | Liquidity, FVG, OB | G5 |
...
**G5 — Dealing Range Ready:** StructureLeg consumption, range availability, Premium/EQ/Discount, revision sem repaint.

## Regra Crítica

- Preservar e testar `FIBONACCI_ANCHOR`
- Impedir que Liquidity recrie o dealing range
- Ownership exclusivo de DealingRangeV3

## Caminhos Batch

- `smc_engine_v3/retracements.py`

## Caminhos Incrementais

- `incremental/components/retracements.py`
