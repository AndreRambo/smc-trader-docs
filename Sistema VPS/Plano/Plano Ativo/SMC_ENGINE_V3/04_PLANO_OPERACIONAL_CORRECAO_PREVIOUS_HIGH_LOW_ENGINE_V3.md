...
---
# SEÇÕES ESPECÍFICAS — PREVIOUS HIGH/LOW ENGINE V3

## Ownership do Domínio (Confirmado)

Previous Period é dona exclusiva de:
- `PreviousPeriodLevelV3`
- `PreviousPeriodLevelEventV3`
- `PreviousPeriodEngineStateV3`

**Regra:** Previous Period consome `TradingPeriodSummaryV3` de Sessions. Não pode criar `CompletedPeriodV3` autoritativo concorrente.

## Contratos Produzidos

| Contrato | Consumidor | Gate |
|---|---|---|
| `PreviousPeriodLevelV3` | Liquidity | G4 |
| `PreviousPeriodLevelEventV3` | Liquidity | G4 |

## Contratos Consumidos

| Contrato | Produtor | Gate |
|---|---|---|
| `TradingPeriodSummaryV3` | Sessions | G1 |
...
**G4 — Previous Period Ready:** consumo de PeriodSummary, níveis disponíveis causalmente, wick/close/gap separados, IDs estáveis.

## Regra Crítica

- Usar `TradingPeriodSummaryV3` de Sessions para obter período de referência
- Não usar resampling concorrente quando Sessions já fornecer período
- `level_available_index >= reference_period_completed_index`

## Caminhos Batch

- `smc_engine_v3/previous_high_low.py`

## Caminhos Incrementais

- `incremental/components/previous_high_low.py`
