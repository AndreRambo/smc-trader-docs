...
**Versão:** 2.1  
**Estado:** `ACTIVE`  
**Data de atualização:** 2026-06-30  
**Autoridades de estado atual:**

- `ARQUITETURA_OFICIAL.md` (NÍVEL 0)
- `RELATORIO_ENGINES_INDICADORES_ZONAS.md` (NÍVEL 0)

**Documento superior de orquestração:**

- `00_PLANO_MESTRE_ORQUESTRACAO_8_ENGINES_SMC_V3.txt` (NÍVEL 1)
...
|---:|---|---|
| 00 | `00_PLANO_MESTRE_ORQUESTRACAO_8_ENGINES_SMC_V3.txt` | Ordem global, contratos, ownership, gates, integração e cutover |
| 01 | `01_PLANO_OPERACIONAL_CORRECAO_SESSIONS_ENGINE_V3.md` | Calendário, sessões, DST, trading date e períodos concluídos |
| 02 | `02_PLANO_OPERACIONAL_CORRECAO_SWING_ENGINE_V3.md` | Raw pivots, canonical swings, supersession e EQH/EQL geométrico |
| 03 | `03_PLANO_OPERACIONAL_CORRECAO_STRUCTURE_ENGINE_V3.md` | BOS, CHOCH, trend state, StructureLeg e protected/weak |
| 04 | `04_PLANO_OPERACIONAL_CORRECAO_PREVIOUS_HIGH_LOW_ENGINE_V3.md` | PDH/PDL, PWH/PWL, PMH/PML e eventos dos níveis anteriores |
| 05 | `05_PLANO_OPERACIONAL_CORRECAO_RETRACEMENT_PRICING_ENGINE_V3.md` | DealingRange, retracement e Premium/Equilibrium/Discount |
| 06 | `06_PLANO_OPERACIONAL_CORRECAO_LIQUIDITY_ENGINE_V3.md` | BSL/SSL, pools, sweeps, ERL/IRL, reclaim e lifecycle |
| 07 | `07_PLANO_OPERACIONAL_CORRECAO_FVG_ENGINE_V3.md` | FVG, IFVG, BPR, displacement e lifecycle |
| 08 | `08_PLANO_OPERACIONAL_CORRECAO_ORDER_BLOCK_ENGINE_V3.md` | Order Blocks, origem do impulso, refinement, freshness e lifecycle |
